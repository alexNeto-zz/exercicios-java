...
public class Singup implements ActionListener {
	...
	private UsuariosDB novoUsuario = new UsuariosDB();
	...
	public Singup() {
		 ...
		 * senhaRepeteLabel.setBounds(15, 265, 100, 15); singup.add(senhaRepeteLabel);
		 * 
		 * senhaRepete = new JPasswordField(); senhaRepete.setBounds(150, 265, 240, 40);
		 * singup.add(senhaRepete); senhaRepete.setColumns(10);
		 */
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(cadastrarButton)) {
			String[] dadosUsuario = { primeiroNome.getText(), ultimoNome.getText(), userNameCadastro.getText(),
					email.getText(), new String(senha.getPassword()) };
			novoUsuario.setNovoUsuario(dadosUsuario);
			novoUsuario.insere();
			if (novoUsuario.getSalvo()) {
